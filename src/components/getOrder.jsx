...
//Images import 
import getOrderImage from '../assets/img/getOrder.png';
    ...
    <>
      ...
      <article className="flex flex-col md:flex-row-reverse w-full h-auto justify-start mt-24">
          ...
          <div className="flex flex-col-reverse sm:flex-row w-full sm:justify-between">
            <div className="flex flex-col pt-4 space-y-8 sm:pt-12 lg:pt-0">
              <div className="flex flex-row justify-center sm:justify-start space-x-3 text-vivid-cyan">
                <FaJava className="h-[30px] w-[30px]" />
                <SiMicrosoftsqlserver className="h-[30px] w-[30px]" />
              </div>
            ...
            <div className="flex justify-center sm:justify-start lg:hidden pt-4 sm:pt-0">
              <img className=" h-[120px] sm:h-[155px] rounded-md" src={getOrderImage} alt="Imagen de getOrder" />
        ...
        <div className="sm:basis-2/5 lg:basis-1/2 h-72 hidden lg:flex rounded-xl">
          <img className="sm:mr-4 lg:mr-14 lg:h-[200px] xl:h-full rounded-xl " src={getOrderImage} alt="Imagen de getOrder" />
        </div>
      </article >
    </>
  )
